...
Route::group(['middleware' => ['json.response', 'auth_maker']], function () {
  ...
  Route::controller(ApplySafController::class)->group(function () {
    Route::post('saf/apply', 'applySaf');                                                        
    //Applying Saf Route                                                   #API_ID=010101
    Route::post('saf/gb-apply', 'applyGbSaf');                                
    // Applying GB Saf                                                     #API_ID =010102
  });

  Route::controller(ActiveSafController::class)->group(function () {
    Route::get('saf/master-saf', 'masterSaf');                                                    
     // Get all master data in Saf                                            #API_ID=010103
    Route::post('saf/edit', 'editSaf');
    // Edit Saf By Back Office    #API_ID = 010104                                                 
    Route::post('saf/inbox', 'inbox');                                                   
    // Saf Inbox                                                            #API_ID = 010105
    Route::post('saf/btc-inbox', 'btcInbox');                                             
    // Saf Inbox for Back To citizen                          #API_ID = 010106                    
    Route::post('saf/field-verified-inbox', 'fieldVerifiedInbox');                        
    // Field Verified Inbox                             #API_ID = 010107                          
    Route::post('saf/outbox', 'outbox');
    // Saf Workflow Outbox and Outbox By search key                      #API_ID = 010108
    Route::post('saf-details', 'safDetails');
    // Saf Workflow safDetails and safDetails By ID                      #API_ID = 010109
    Route::post('saf/escalate', 'postEscalate');                                          
     // Saf Workflow special and safDetails By id                        #API_ID = 010110
    Route::post('saf/escalate/inbox/{key?}', 'specialInbox');                           
    // Saf workflow Inbox and Inbox By search key                        #API_ID = 010111
    Route::post('saf/independent-comment', 'commentIndependent');                          
    // Independent Comment for SAF Application                           #API_ID = 010112
    Route::post('saf/post/level', 'postNextLevel');                                        
    // Forward or Backward Application                                   #API_ID = 010113
    Route::post('saf/approvalrejection', 'approvalRejectionSaf');
    // Approval Rejection SAF Application                               #API_ID = 010114
    Route::post('saf/back-to-citizen', 'backToCitizen');                                   
    // Saf Application Back To Citizen                                  #API_ID = 010115
    Route::post('saf/get-prop-byholding', 'getPropByHoldingNo');                     
    // get Property (search) by ward no and holding no                  #API_ID = 010116
    Route::post('saf/generate-order-id', 'generateOrderId');                               
    // Generate Order ID                                                #API_ID = 010117
    Route::get('saf/prop-transactions', 'getPropTransactions');                          
    // Get Property Transactions                                        #API_ID = 010118
    Route::post('saf/site-verification', 'siteVerification');                             
    // Ulb TC Site Verification                                         #API_ID = 010119
    Route::post('saf/geotagging', 'geoTagging');                                          
    // Geo Tagging                                                      #API_ID = 010120
    Route::post('saf/get-tc-verifications', 'getTcVerifications');                        
    // Get TC Verifications Data                                       #API_ID = 010121
    Route::post('saf/proptransaction-by-id', 'getTransactionBySafPropId');                
    // Get Property Transaction by Property ID or SAF id                #API_ID = 010122
    Route::post('saf/get-demand-by-id', 'getDemandBySafId');                              
    // Get the demandable Amount of the Property from Admin Side        #API_ID = 010123
    ...
    Route::post('saf/static-saf-dtls', 'getStaticSafDetails');                             
    //Static SAf Details                                                 #API_ID = 010126
    Route::post('saf/offline-saf-payment', 'offlinePaymentSaf');                                  
    // SAF Payment                                                       #API_ID = 010127
  });
  ...
  Route::controller(SafDocController::class)->group(function () {
    Route::post('saf/document-upload', 'docUpload');                                             
    // Upload Documents for SAF                                        #API_ID = 010201
    Route::post('saf/get-uploaded-documents', 'getUploadDocuments');
    // View Uploaded Documents for SAF                                 #API_ID = 010202
    Route::post('saf/get-doc-list', 'getDocList');                                      
     // Get Document Lists                                             #API_ID = 010203
    Route::post('saf/doc-verify-reject', 'docVerifyReject');
    // Verify or Reject Saf Documents                                  #API_ID = 010204
  });
  ...
  Route::controller(ConcessionController::class)->group(function () {
    ...
    //( Citizen Independent comment and Level Pendings )                 #API_ID = 010612
  ...
  Route::controller(ObjectionController::class)->group(function () {
    ...
    // Escalate the application and send to special category                #API_ID = 010709
    Route::post('objection/special-inbox', 'specialInbox');
    // Special Inbox                                                         #API_ID = 010710
  ...
  Route::controller(HoldingTaxController::class)->group(function () {
    ...
    //Property/Holding Yearly Holding Tax Generation                             #API_ID = 011501
...
Route::group(['middleware' => ['json.response', 'auth_maker']], function () {
  Route::controller(ActiveSafController::class)->group(function () {
    Route::post('saf/master-saf', 'masterSaf');                                               
    // Get all master data in Saf                                       #API_ID = 010103
    Route::post('saf/saf-payment',  'paymentSaf');                              
    // SAF Payment                                                      #API_ID = 010128
    Route::post('saf/calculate-by-saf-id', 'calculateSafBySafId');                                 
    // Calculate SAF By SAF ID From Citizen                             #API_ID = 010129
    Route::post('saf/independent/generate-order-id', 'generateOrderId');                           
     // Generate Order ID                                               #API_ID = 010117
    Route::post('saf/payment-receipt', 'generatePaymentReceipt');                               
    // Generate payment Receipt                                         #API_ID = 010130
  });
   ...
   */
  Route::controller(HoldingTaxController::class)->group(function () {
    Route::post('payment-holding', 'paymentHolding');                                         
    //Payment Holding (For Testing Purpose)                             #API_ID = 011509
    ...
    //Property Ulb Payment Receipt                                     #API_ID = 011514
    Route::post('prop-comparative-demand', 'comparativeDemand');                             
    //Property Comparative Demand                                      #API_ID = 011515
    Route::post('cluster/payment-history', 'clusterPaymentHistory');                          
    //Cluster Payment History                                          #API_ID = 011516
    Route::post('cluster/payment-receipt', 'clusterPaymentReceipt');                          
    //Generate Cluster Payment Receipt for Saf and Property            #API_ID = 011517
  });
});
/**
