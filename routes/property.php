...
Route::controller(MasterReferenceController::class)->group(function () {
  ...
  //m- user manual description
  Route::post('m-heading-description-create', 'addHeadingDescription');
  Route::post('m-heading-description-list', 'userHeadingList');
  Route::post('m-heading-description-update', 'updateHeading');
  ...
  //m- Administrative
  Route::post('m-administrative-create', 'addAdministrative');
  Route::post('m-administrative-update', 'updateAdministrative');
  Route::post('m-administrative-list', 'listAdministrative');
  Route::post('m-administrative-get-by-id', 'administrativebyId');
  Route::post('m-administrative-delete', 'deleteAdministrative');
...
Route::controller(HoldingTaxController::class)->group(function () {
  ...
  Route::post('get-tran-by-holding-no', 'getTransactionsByHoldingNo');           
});
