...
class WaterRejectionApplicationDetail extends Model
{
    ...
    public function getApplicationWithStatus($request)
    {
        ...
        if ($request->connectionType) {
            $approved->where('water_rejection_application_details.connection_type_id', $request->connectionType);
        }
        if ($request->propertyType) {
            $approved->where('water_rejection_application_details.property_type_id', $request->propertyType);
        }
        $data = null;
