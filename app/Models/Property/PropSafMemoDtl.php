    ...
    public function getMemoDtlsByMemoId($memoId)
    {
        $query = "SELECT d.*,
                    TO_CHAR(d.created_at,'DD-MM-YYYY') AS memo_date,
                            ...
                            JOIN (SELECT owner_name,guardian_name,saf_id,relation_type FROM prop_active_safs_owners ORDER BY id) AS o ON o.saf_id=d.saf_id
    ...
    public function getPropMemoDtlsByMemoId($memoId)
    {
        $query = "SELECT d.*,
                    TO_CHAR(d.created_at,'DD-MM-YYYY') AS memo_date,
                            ...
                            FROM prop_saf_memo_dtls d
                            LEFT JOIN (SELECT owner_name,guardian_name,saf_id,relation_type FROM prop_owners ORDER BY id) AS o ON o.saf_id=d.saf_id
