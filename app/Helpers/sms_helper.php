...
if (!function_exists('SMSJHGOVT')) {
    function SMSJHGOVT($mobileno, $message, $templateid = null)
    {
        if (strlen($mobileno) == 10 && is_numeric($mobileno) && $templateid != NULL) {
            $username      = Config::get("sms-constants.jh_user_name");               #_username of the department
            $password      = Config::get("sms-constants.jh_password");                #_password of the department
            $senderid      = Config::get("sms-constants.jh_sender_id");               #_senderid of the deparment
            $deptSecureKey = Config::get("sms-constants.jh_secure_key");              #_departmentsecure key for encryption of message...
            $url           = Config::get("sms-constants.jh_url");
