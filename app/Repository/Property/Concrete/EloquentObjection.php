...
use App\Repository\Property\iObjectionRepository;
...
class EloquentObjection implements ObjectionRepository
{
    ...
    public function propObjectionInbox($key)
    {
        try {
            ...
            $data = PropertyObjection::select(
                DB::raw("property_objections.id as objection_id,
