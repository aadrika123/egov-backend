            ...
            if ($details->objection_for == 'Assessment Error') {
                ...
                if ($objectionFlooorDtls->isNotEmpty()) {
                    ...
                    $objectionFloorElement = [
                        ...
                        'tableHead' => ["Floor No.", "Usage Type", "Occupancy Type", "Construction Type", "Built Up Area (in Sq. Ft.)"],
                        'tableData' => array()
                    ];
                    $floorElement = [
                        'headerTitle' => 'Floor Details',
                        'tableHead' => ["#", "Floor", "Usage Type", "Occupancy Type", "Construction Type", "Build Up Area (in Sq. Ft.)"],
                        'tableData' => array()
                    ];
